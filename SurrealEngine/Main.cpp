...
int main() //hPrevInstance always null, lpCmdLine commandline van de instance
{																									//window to be handel

	Wnd wnd("MainWindow", "First window :D", 1280, 720, 100, 100);
	Wnd wnd2("SecondWindow", "Second window ^_^", 860, 640, 1000, 300);
