...
bool Object::Init(Renderer* renderer)
{
	...
	if (initialised == false)
	{
		...
		xyzTextureVertex* vertices = new xyzTextureVertex[numOfVertices] //vertex array
		{
			...
			{ 1.0f, 1.0f,  -1.0f, 1,0 , 0x00800000 },		//1
			{ -1.0f, -1.0f, -1.0f, 0,1, 0x00800000 },	//2
			{ 1.0f, -1.0f,  -1.0f, 1,1, 0x00800000 },	//3

			{ -1.0f, 1.0f, 1.0f, 1,0,0x00800000 },		//4
			{ 1.0f, 1.0f,  1.0f, 1,1,0x00800000 },		//5
			{ -1.0f, -1.0f, 1.0f, 0,0,0x00800000 },		//6
			{ 1.0f, -1.0f,  1.0f, 0,1,0x00800000 },		//7
		};
