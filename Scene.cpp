...
Scene::Scene()
{
	...
	AddCamera(0, D3DXVECTOR3(-100, 250, -100), D3DXVECTOR3(250, 0, 250), D3DXVECTOR3(0, 0, 0));			//game camera
	AddCamera(1, D3DXVECTOR3(256, 512, 256), D3DXVECTOR3(256, 0, 256), D3DXVECTOR3(0, 0, 0));		//dev camera
}
